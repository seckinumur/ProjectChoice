<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteMail.aspx.cs" Inherits="ProjectChoice.SiteMail" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <!-- Head Bölümü temel gereksinimler
    ================================================== -->
    <meta charset="utf-8"/>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-lg-9">
                        <asp:Label ID="txtSonuc" runat="server" Visible="False"></asp:Label><br />
